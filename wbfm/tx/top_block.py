...
# Title: Top Block
# Generated: Tue Mar 20 11:04:20 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.pulse_monitor = audio.source(44100, '', True)
        self.osmosdr_sink_0 = osmosdr.sink( args="numchan=" + str(1) + " " + '' )
        self.osmosdr_sink_0.set_sample_rate(2e6)
        self.osmosdr_sink_0.set_center_freq(120e6, 0)
        ...
        self.connect((self.pulse_monitor, 0), (self.blocks_multiply_const_vxx_0, 0))
